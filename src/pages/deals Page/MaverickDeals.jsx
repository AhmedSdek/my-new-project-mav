...
function MaverickDeals() {
  ...
  const uniqueCompoundName = [
    ...new Set(data.map((item) => item.compoundName)),
  ];
      ...
      >
                      ...
                      >
                        <Stack>
                          ...
                          <CardContent style={{ padding: "15px 15px 0 15px" }}>
                            ...
                            >
                              <p
                                style={{ fontWeight: "bold", color: "#1e4164" }}
                              >
                                {`${item.Sale}`}
                              </p>
                            </Box>
        ...
        >
          ...
          <Stack>
                ...
                {uniqueSale.map((sale, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      padding: "5px",
                      margin: "5px",
                      backgroundColor: filters.Sale.includes(sale) && "#015c9a",
                      color: filters.Sale.includes(sale) && "white",
                    }}
                    checked={filters.Sale.includes(sale)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "Sale")}
                    control={<Checkbox sx={{ display: "none" }} name={sale} />}
                    label={sale}
                  />
                ))}
              </Stack>
            ...
            <Divider
              sx={{ borderColor: "rgb(1, 92, 154)", margin: "10px 0" }}
            />
            <FormGroup>
              <Typography variant="body1" sx={{ fontWeight: "bold" }}>
                Location
                ...
                {uniqueLocation.map((location, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      margin: "5px",
                      backgroundColor:
                        filters.Location.includes(location) && "#015c9a",
                      color: filters.Location.includes(location) && "white",
                    }}
                    checked={filters.Location.includes(location)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "Location")}
                    control={
                      <Checkbox sx={{ display: "none" }} name={location} />
                    }
                    label={location}
                  />
                ))}
                ...
                {uniqueDevname.map((devname, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      margin: "5px",
                      backgroundColor:
                        filters.devname.includes(devname) && "#015c9a",
                      color: filters.devname.includes(devname) && "white",
                    }}
                    checked={filters.devname.includes(devname)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "devname")}
                    control={
                      <Checkbox sx={{ display: "none" }} name={devname} />
                    }
                    label={devname}
                  />
                ))}
                ...
                {uniqueType.map((type, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      padding: "5px",
                      margin: "5px",
                      backgroundColor: filters.Type.includes(type) && "#015c9a",
                      color: filters.Type.includes(type) && "white",
                    }}
                    checked={filters.Type.includes(type)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "Type")}
                    control={<Checkbox sx={{ display: "none" }} name={type} />}
                    label={type}
                  />
                ))}
              </Stack>
                ...
                {uniqueDelivery.map((delivery, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      margin: "5px",
                      backgroundColor:
                        filters.delivery.includes(delivery) && "#015c9a",
                      color: filters.delivery.includes(delivery) && "white",
                    }}
                    checked={filters.delivery.includes(delivery)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "delivery")}
                    control={
                      <Checkbox sx={{ display: "none" }} name={delivery} />
                    }
                    label={delivery}
                  />
                ))}
            ...
            <FormGroup>
              ...
              <Stack
                sx={{ flexDirection: "row", flexWrap: "wrap", padding: "5px" }}
              >
                {uniqueFinsh.map((finsh, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      margin: "5px",
                      backgroundColor:
                        filters.Finsh.includes(finsh) && "#015c9a",
                      color: filters.Finsh.includes(finsh) && "white",
                    }}
                    checked={filters.Finsh.includes(finsh)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "Finsh")}
                    control={<Checkbox sx={{ display: "none" }} name={finsh} />}
                    label={finsh}
                  />
                ))}
              </Stack>
                ...
                {uniqueCompoundName.map((compoundName, index) => (
                  <FormControlLabel
                    sx={{
                      ...
                      margin: "5px",
                      backgroundColor:
                        filters.compoundName.includes(compoundName) &&
                        "#015c9a",
                      color:
                        filters.compoundName.includes(compoundName) && "white",
                    }}
                    checked={filters.compoundName.includes(compoundName)}
                    key={index}
                    onChange={(e) => handleCheckboxChange(e, "compoundName")}
                    control={
                      <Checkbox sx={{ display: "none" }} name={compoundName} />
                    }
                    label={compoundName}
                  />
                ))}
            ...
            <Typography
              variant="body1"
              sx={{ fontWeight: "bold", color: "rgb(255 145 77)" }}
            >
              Sort
            </Typography>
            <Stack gap={2} sx={{ width: "60%" }}>
              ...
              <Button
                ...
                sx={{
                  border: "1px solid rgb(224, 224, 224)",
                  borderRadius: "30px",
                  backgroundColor: areaSort1 && "rgb(255 145 77)",
                  color: areaSort1 && "white",
                  "&:hover": {
              ...
              <Button
                ...
                sx={{
                  border: "1px solid rgb(224, 224, 224)",
                  borderRadius: "30px",
                  backgroundColor: areaSort2 && "rgb(255 145 77)",
                  color: areaSort2 && "white",
                  "&:hover": {
            ...
            <Stack gap={2} sx={{ width: "60%" }}>
              ...
              <Button
                ...
                sx={{
                  border: "1px solid rgb(224, 224, 224)",
                  borderRadius: "30px",
                  backgroundColor: priceSort1 && "rgb(255 145 77)",
                  color: priceSort1 && "white",
                  "&:hover": {
              ...
              <Button
                ...
                sx={{
                  border: "1px solid rgb(224, 224, 224)",
                  borderRadius: "30px",
                  backgroundColor: priceSort2 && "rgb(255 145 77)",
                  color: priceSort2 && "white",
                  "&:hover": {
