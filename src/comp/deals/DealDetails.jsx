                  ...
                  >
                    ...
                    >
                      {`${Intl.NumberFormat("en-US").format(
                        value.data().price
                      )} ${value.data().monyType === "dollar" ? "$" : "EGP"}`}
                    ...
                    <TableHead>
                      <TableRow>
                        <StyledTableCell
                          ...
                          colSpan={2}
                        >{`About ${value.data().Type}`}</StyledTableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
